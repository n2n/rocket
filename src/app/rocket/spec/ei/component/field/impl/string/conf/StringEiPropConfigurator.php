...
use rocket\spec\ei\component\field\impl\string\StringEiProp;
...
class StringEiPropConfigurator extends AlphanumericEiPropConfigurator {
	...
	/**
	 * {@inheritDoc}
	 * @see \rocket\spec\ei\component\field\impl\string\conf\AlphanumericEiPropConfigurator::createMagDispatchable($n2nContext)
