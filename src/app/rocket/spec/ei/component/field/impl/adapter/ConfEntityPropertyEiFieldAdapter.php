...
abstract class ConfEntityPropertyEiFieldAdapter extends IndependentEiFieldAdapter implements ConfEntityPropertyEiField {
	...
	/* (non-PHPdoc)
	 * @see \rocket\spec\ei\component\field\impl\adapter\ConfEntityPropertyEiField::getEntityProperty()
	 */
	...
	public function createEiFieldConfigurator(): EiFieldConfigurator {
		...
		$eiFieldConfigurator->registerConfEntityPropertyEiField($this);
