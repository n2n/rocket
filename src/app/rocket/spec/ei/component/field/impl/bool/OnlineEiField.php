...
use rocket\spec\ei\component\field\impl\bool\conf\OnlineEiFieldConfigurator;
use rocket\spec\ei\component\field\indepenent\EiFieldConfigurator;

class OnlineEiField extends BooleanEiField {
	...
	public function createEiFieldConfigurator(): EiFieldConfigurator {
		return new OnlineEiFieldConfigurator($this);
	}
}
