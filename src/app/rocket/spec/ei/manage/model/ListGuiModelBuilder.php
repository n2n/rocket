...
interface ListGuiModelBuilder {
	 ...
	 */
	public function getEntryGuiModelByKey(int $key): EntryGuiModel;
	
	/**
	 * @return \rocket\spec\ei\manage\model\ListGuiModel
	 */
	public function toListGuiModel(): ListGuiModel;
}
