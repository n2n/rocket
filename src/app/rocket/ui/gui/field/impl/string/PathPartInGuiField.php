...
class PathPartInGuiField extends InGuiFieldAdapter implements GuiField, SiFieldModel {

	function __construct(private PathPartInSiField $siField) {
		parent::__construct($this->siField);
	}

	protected function createInputMappers(N2nContext $n2nContext): array {
		return [Mappers::pathPart(null, null, $this->siField->isMandatory(), $this->siField->getMinlength(),
	...
	function getSiField(): PathPartInSiField {
		return $this->siField;
	}
