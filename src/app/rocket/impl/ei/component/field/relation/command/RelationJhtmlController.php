 ...
 */
namespace rocket\impl\ei\component\field\relation\command;
...
use rocket\impl\ei\component\field\relation\model\mag\MappingForm;
...
class RelationJhtmlController extends ControllerAdapter {
	...
	public function doNewMappingForm(ParamQuery $propertyPath, ParamQuery $draft, ParamQuery $chooseableEiTypeIds = null) {
		...
		$view = $this->createView('\rocket\impl\ei\component\field\relation\view\pseudoMappingForm.html',
