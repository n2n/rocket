...
use rocket\impl\ei\component\field\string\conf\PathPartEiPropConfigurator;
...
class PathPartEiProp extends AlphanumericEiProp  {
	...
	/* (non-PHPdoc)
	 * @see \rocket\impl\ei\component\field\PropertyEditableEiPropAdapter::createEiConfigurator()
	 */
