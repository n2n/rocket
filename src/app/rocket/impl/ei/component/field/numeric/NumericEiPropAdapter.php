...
// 	}
	...
	/**
	 * {@inheritDoc}
	 * @see \rocket\spec\ei\component\field\FilterableEiProp::buildManagedFilterField($eiFrame)
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see \rocket\spec\ei\component\field\SortableEiProp::createGlobalSortField()
	 * @return SortField
	 */
