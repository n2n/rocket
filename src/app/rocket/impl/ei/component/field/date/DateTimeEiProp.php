 ...
 */
namespace rocket\impl\ei\component\field\date;
...
use rocket\impl\ei\component\field\date\conf\DateTimeEiPropConfigurator;
...
class DateTimeEiProp extends DraftableEiPropAdapter implements SortableEiProp {
	...
	/* (non-PHPdoc)
	 * @see \rocket\spec\ei\component\field\SortableEiProp::createSortCriteriaConstraint()
	 */
