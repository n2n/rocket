...
//	/**
//	 * @var EiuGuiEntryAssembler[]
//	 */
//	private $eiuGuiEntryAssemblers = array();
...
//			EiuGuiEntryAssembler $eiuGuiEntryAssembler, $mandatory, $active) {
...
//		$this->eiuGuiEntryAssemblers[$n2nLocaleId] = $eiuGuiEntryAssembler;
//		if ($mandatory) {
...
//		}
//
//		foreach ($this->eiuGuiEntryAssemblers as $n2nLocaleId => $eiuGuiEntryAssembler) {
//			$dispatchable = $eiuGuiEntryAssembler->getEiuGuiEntry()->getDispatchable();
//			$eiuGuiEntryAssembler->getEiuGuiEntry()->entry()->isNew();
...
//		}
//
//		foreach ($this->eiuGuiEntryAssemblers as $eiuGuiEntryAssembler) {
//			$eiuGuiEntryAssembler->finalize();
//		}
//
//		return $this;
//	}
...
//			$this->eiuGuiEntryAssemblers[$n2nLocaleId]->getEiuGuiEntry()->save();
