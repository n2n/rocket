...
<div class="rocket-impl-content-items"<?php $view->out($panelLayout->hasGrid() ? ' style="display:grid, display: repeat(' . ($panelLayout->getNumGridCols() - 1). ', 1fr)" class="rocket-impl-grid"' : null) ?>>
