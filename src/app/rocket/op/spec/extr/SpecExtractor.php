...
use rocket\op\spec\InvalidLaunchPadConfigurationException;
...
// 		$extraction->setDefaultEiMaskId($eiTypeDataSet->getString(RawDef::EI_DEFAULT_MASK_ID, false, null, true));
	...
	/**
	 * @return \rocket\op\spec\extr\EiTypeExtensionExtraction[][]
	 */
