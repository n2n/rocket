 ...
 * 	the {@see \rocket\op\spec\Spec} to load the current configuration.</p>
 * 
...
class SpecExtractionManager {
	...
	/**
	 * @return \rocket\op\spec\source\ModularConfigSource
	 */
...
// 	}
	 ...
	 * @throws IllegalStateException
	 * @return \rocket\op\spec\extr\SpecConfigSourceDecorator
	 */
