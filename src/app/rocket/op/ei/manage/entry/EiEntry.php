...
// 	private $accessible = true;
	...
	/**
	 * @return \rocket\op\ei\manage\security\EiEntryAccess
	 */
...
//	}
	...
	/**
	 * @return \rocket\op\ei\manage\entry\EiEntryValidationResult
	 */
...
class OnWriteMappingListener implements EiEntryListener {
	...
	/* (non-PHPdoc)
	 * @see \rocket\op\ei\manage\entry\EiEntryListener::validated()
	 */
