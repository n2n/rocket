...
class SimpleCountDraftStmtBuilder extends DraftStmtBuilderAdapter implements CountDraftStmtBuilder {
	...
	/* (non-PHPdoc)
	 * @see \rocket\op\ei\manage\draft\stmt\FetchDraftStmtBuilder::getDraftIdQueryItem()
	 */
	...
	/* (non-PHPdoc)
	 * @see \rocket\op\ei\manage\draft\stmt\FetchDraftStmtBuilder::getLastModQueryItem()
	 */
	...
	/* (non-PHPdoc)
	 * @see \rocket\op\ei\manage\draft\stmt\FetchDraftStmtBuilder::getEntityObjIdQueryItem()
	 */
	...
	/* (non-PHPdoc)
	 * @see \rocket\op\ei\manage\draft\stmt\FetchDraftStmtBuilder::getUserIdQueryItem()
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see \rocket\op\ei\manage\draft\stmt\FetchDraftStmtBuilder::buildResult()
	 */
