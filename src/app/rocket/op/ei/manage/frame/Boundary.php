...
class Boundary {
	...
	/**
	 * Used for filters directly assigned to an {@see \rocket\op\ei\mask\EiMask} (e. g. in specs.json or by hangar).
	 * @var int
	 */
	const TYPE_HARD_FILTER = 16;
	/**
	 * Used for sorts directly assigned to an {@see \rocket\op\ei\mask\EiMask} (e. g. in specs.json or by hangar).
	 * @var int
	 */
	...
	/**
	 * @return \rocket\op\ei\manage\frame\CriteriaFactory|null
	 */
