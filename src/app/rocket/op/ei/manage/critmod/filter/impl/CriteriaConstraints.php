 ...
 */
namespace rocket\op\ei\manage\critmod\filter\impl;
...
class CriteriaConstraints {

	static function noResult(): CriteriaConstraint {
		return new ComparatorConstraintGroup(true,
				[new SimpleComparatorConstraint(CrIt::c(1), '=', CrIt::c(0))]);
	}
}
