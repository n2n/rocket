<?php
namespace rocket\op\ei\util\sort;
...
use rocket\op\ei\util\sort\form\SortForm;
...
class EiuSortForm implements Dispatchable, UiComponent {
	...
	/**
	 * @return \rocket\op\ei\manage\critmod\sort\SortSettingGroup
	 */
	...
	function createView(HtmlView $contextView = null) {
		...
		return $viewFactory->create('rocket\op\ei\util\sort\view\eiuSortForm.html', array('eiuSortForm' => $this));
	}
